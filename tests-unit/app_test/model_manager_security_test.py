...
async def test_get_model_preview_path_traversal_rejected(aiohttp_client, app, tmp_path):
    ...
    with patch('folder_paths.folder_names_and_paths', {
        ...
        # Traversal with encoded slashes/dots so client doesn't collapse path locally
        url = URL('/experiment/models/preview/test_folder/0/..%2f..%2foutside.png', encoded=True)
