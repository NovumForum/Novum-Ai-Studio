    ...
    def add_routes(self, routes):
        ...
        async def get_model_preview(request):
            ...
            try:
                ...
                return web.Response(status=400, text="Invalid path index")
            ...
            # Prevent path traversal outside of folder
            if os.path.commonpath([folder, full_filename]) != folder:
                return web.Response(status=403, text="Invalid path requested")
