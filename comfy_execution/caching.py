...
def to_hashable(obj):
    ...
    # Fast-path primitive types and convert sequence structures (list/tuple) directly
    # to tuples instead of wrapping with frozenset(zip(itertools.count(), ...)).
    # Maps are converted directly to frozenset of key-value pairs without sorting,
    # since frozenset hashing and equality are order-independent.
