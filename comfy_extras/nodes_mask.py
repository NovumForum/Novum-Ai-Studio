...
class SolidMask(IO.ComfyNode):
    ...
    def define_schema(cls):
        return IO.Schema(
            ...
            category="mask",
            inputs=[
                IO.Float.Input("value", default=1.0, min=0.0, max=1.0, step=0.01, display_mode=IO.NumberDisplay.slider),
...
class ThresholdMask(IO.ComfyNode):
    ...
    def define_schema(cls):
        return IO.Schema(
            ...
            inputs=[
                IO.Mask.Input("mask"),
                IO.Float.Input("value", default=0.5, min=0.0, max=1.0, step=0.01, display_mode=IO.NumberDisplay.slider),
            ],
            outputs=[IO.Mask.Output()],
        )
